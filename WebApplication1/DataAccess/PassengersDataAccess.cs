            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                        ...
                        while (rdr.Read())
                    {
                        ...
                        passengers.ID_departure = Convert.ToInt32(rdr["ID_departure"]);
                        passengers.ID_passenger = Convert.ToInt32(rdr["ID_passenger"]);
                        passengers.Service_class = rdr["Service_class"].ToString();
                        passengers.Passenger_lastname = rdr["Passenger_lastname"].ToString();
                        passengers.Passenger_name = rdr["Passenger_name"].ToString();
        ...
        public int AddPassengers(Passengers passengers)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    ...
                    cmd.Parameters.AddWithValue("@ID_departure", passengers.ID_departure);
                    cmd.Parameters.AddWithValue("@ID_passenger", passengers.ID_passenger);
                    cmd.Parameters.AddWithValue("@Service_class", passengers.Service_class);
                    cmd.Parameters.AddWithValue("@Passenger_lastname", passengers.Passenger_lastname);
                    cmd.Parameters.AddWithValue("@Passenger_name", passengers.Passenger_name);
